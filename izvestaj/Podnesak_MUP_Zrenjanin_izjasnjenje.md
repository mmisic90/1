...
Примопредају брода по завршеним радовима требало је да изврше **штетници 1. и 2. реда** — BEGEJ SHIPYARDS GROUP DOO ZRENJANIN, преко директора Душка Топаловића, који су оштећеном и понудили Записник о преузимању брода, са примопредајом заказаном за дан 11.09.2025. године.

Лице које обавља посао (извођач радова — посленик) дужно је да по завршеном послу обавести налогодавца (наручиоца) и да му преда ствар у посед ради провере да ли је посао обављен према договореном. Сходно томе, штетник 1. реда је био дужан да брод **преда у посед оштећеном** (чл. 613. Закона о облигационим односима), а све **док се брод налазио у поседу штетника, до уредне примопредаје, на штетнику је била одговорност за све што се са бродом догоди**. Управо је штетник, заказивањем Записника о преузимању за 11.09.2025. године, и сам признао да сматра да је посао завршен и брод спреман за предају. Примопредаја, међутим, није извршена из разлога наведених у тачки I.4. овог изјашњења, а пре ње је утврђено да су витални делови брода отуђени, односно да је брод оштећен — док је био искључиво у поседу и под надзором штетника.

Детаљна правна анализа одговорности штетника, са одредбама прописа и судском праксом, дата је у тачки IV-А овог изјашњења и у прилозима (Правна анализа и издвојене одлуке судске праксе).
...
1. бродска кабина (оштећена) — **тотална штета**;
2. врата кабине (оштећена) — **тотална штета**;
3. електрична инсталација брода (исечена) — **тотална штета**;
4. бродске кабине — стамбени простор (вандализован) — **тотална штета**;
5. машински простор (оштећен) — **тотална штета**;
6. један погонски агрегат — мотор (оштећен скидањем главе мотора) — **тотална штета**;
7. хидраулична инсталација у машинском простору (исечена) — **тотална штета**.
...
## IV-А — ОСНОВ ОДГОВОРНОСТИ ШТЕТНИКА

Однос оштећеног (наручиоца) и штетника 1. реда заснован је као **уговор о делу** (чл. 600. и даље ЗОО) ради ремонта брода, при чему је брод предат штетнику у државину. Из тог односа за штетника произлази **обавеза чувања поверене ствари** са пажњом **доброг стручњака**, будући да је реч о професионалном бродоградилишту (чл. 18. ст. 2. ЗОО), као и обавеза да брод по завршетку посла **преда у посед** оштећеном (чл. 613. ЗОО).

Како је до отуђења и оштећења делова брода дошло **док је брод био у поседу штетника, пре извршене примопредаје**, штетник за насталу штету одговара по чл. 154. ст. 1, чл. 262. и чл. 18. ст. 2. ЗОО, при чему је **терет доказивања** да штета није настала његовом кривицом (виша сила, случај) **на штетнику** (чл. 263, чл. 262. ст. 5. ЗОО). Подела ризика случајне пропасти из чл. 626. ЗОО овде се не примењује, јер се не ради о случајној пропасти, већ о крађи и вандализму услед пропуста штетника у чувању брода.

Наведено потврђује и судска пракса, нарочито правни став Врховног касационог суда из одлуке **Рев1 7/2017 од 12.10.2017. године**: *„Губитак, пропаст или оштећење ствари другог лица ствара обавезу држаоца ствари да власнику накнади штету у новцу у висини њене тржишне противвредности."* (детаљно у прилогу — Правна анализа и издвојене одлуке).

## IV — ОДШТЕТНИ ЗАХТЕВ

Одштетни захтев истакнут дописом пуномоћника оштећеног од 24.09.2025. године, у износу од 1.500.000,00 евра, овим се **прецизира и увећава**, тако да се на име штете проузроковане извршењем кривичног дела, сагласно чл. 252–256. Законика о кривичном поступку, а у вези са чл. 154, 155, 185, 186, 189. и 395. Закона о облигационим односима, према штетницима 1. и 2. реда истиче одштетни захтев у укупном износу од **1.700.000,00 евра (словима: милион и седамсто хиљада евра)**, све у динарској противвредности по продајном курсу НБС на дан исплате, са законском затезном каматом од дана извршења кривичног дела до исплате.

**Тотална штета на броду.** Отуђењем средства порива и погона брода (оба пропулзера „Schottel" са целокупним системом — два Z погона), агрегата, оштећењем једног погонског агрегата (мотора), исецањем електричне и хидрауличне инсталације и девастирањем кабине и стамбеног простора, брод је изгубио **сва битна својства и функције** због којих би се могао назвати бродом. Брод више није способан ни за пловидбу, ни за погон, ни за привредно искоришћавање — он данас представља **пуку хрпу метала**. Стога је несумњиво да је на броду наступила **ТОТАЛНА ШТЕТА**. Вредност функционалног брода ове врсте, који поседује важећу дозволу Лучке капетаније за пловидбу, износи **700.000,00 евра**, и тај износ представља обичну (стварну) штету насталу тоталном штетом на броду.

По видовима штете, изјашњавамо се:

| Вид штете | Износ |
|---|---|
| **Обична (стварна) штета** — тотална штета на броду; вредност функционалног брода ове врсте са важећом дозволом Лучке капетаније за пловидбу | **700.000,00 евра** |
...
2. предузме мере из своје надлежности ради проналаска отуђених ствари (посебно два пропулзера „Schottel", радара, радио станице и агрегата) и идентификовања извршилаца;
3. о предузетим мерама обавести оштећеног преко пуномоћника.
...
5. Правна анализа одговорности штетника (са одредбама прописа и судском праксом);
6. Издвојене одлуке судске праксе (Рев1 7/2017; Рев 12733/2024; Прев 154/2023);
7. пуномоћ.
